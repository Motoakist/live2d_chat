...
JNIEXPORT void JNICALL
Java_com_example_x3033067lastkadai_JniBridgeJava_changeAllExpression(JNIEnv *env, jclass type, jint expression)
{
    LAppDelegate::GetInstance()->ChangeAllExpression(expression);
}
}
